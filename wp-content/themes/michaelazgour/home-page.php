					...
					<div class="row the-news">
						<div class="col-xl-6 col-l-7 col-xs-16 news-thumb">
							<a href="<?php echo get_sub_field('button')['url']; ?>">
								<?php
								$thumb_id = get_sub_field('image')['ID'];
						...
						<div class="col-xl-10 col-l-9 col-xs-16 news-short">
							<h1><a href="<?php echo get_sub_field('button')['url']; ?>"><?php echo get_sub_field('title') ?></a></h1>
							<h5>
								<?php echo get_sub_field('sub_title'); ?>
							</h5>
							<p class="news-excerpt"><?php echo get_sub_field('text') ?></p>
							<a href="<?php echo get_sub_field('button')['url']; ?>" class="buttonB news-more">
