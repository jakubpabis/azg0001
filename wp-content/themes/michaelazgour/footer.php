	<div class="goTop buttonB">Go to top</div>
	<div class="container-full footer">
		<footer>
			<div class="row footer-up">
				<div class="col-m-53 col-xs-16">
					<div class="row">
						<div class="col-xl-8 col-l-9 col-m-16 col-s-53 col-xs-8">
							<?php if ( is_active_sidebar( 'footer-1' ) ) : ?>
								<?php dynamic_sidebar( 'footer-1' ); ?>
							<?php endif; ?>
						</div>
						<div class="col-xl-8 col-l-7 col-m-16 col-s-106 col-xs-8 socials">
							<div class="row">
							<?php if ( is_active_sidebar( 'footer-22' ) ) : ?>
								<div class="col-m-16 col-xs-16">
				...
				<div class="col-m-53 col-xs-16 border">
					<div class="row">
						<div class="col-m-8 col-s-53 col-xs-8 left">
							<?php if ( is_active_sidebar( 'footer-3' ) ) : ?>
								<?php dynamic_sidebar( 'footer-3' ); ?>
							<?php endif; ?>
						</div>
						<div class="col-m-8 col-s-53 col-xs-8 right">
							<span class="widget-title">Paintings</span>
							<?php years_news_tags_filter(); ?>
						</div>
						<div class="visible-s col-s-53">
							<div class="row">
								<div class="col-xs-16 newsletterWidget">
									<div class="widget widget_newsletterwidget">
										...
										<div class="newsletter newsletter-widget">
											<form id="mc-embedded-subscribe-form" action="//azgour.us8.list-manage.com/subscribe/post?u=593e376b651adaf85ba8c7f2b&id=1302139953" target="_blank" method="post">
												<p>
													<input type="email" name="EMAIL" id="mce-EMAIL" class="newsletter-email" placeholder="Email">
												</p>
												<p>
													<input type="submit" value="Send" id="mc-embedded-subscribe" class="newsletter-submit">
												</p>
											</form>
										</div>
									</div>
				...
				<div class="col-m-53 col-xs-16 hidden-s">
					<div class="row">
			...
			<div class="row footer-down">
				<div class="col-xs-16">
					...
					<path fill="#454545" d="M48.4,0.9h-1.4c-0.6,0-1.8,0.3-2.7,0.6l-0.4,0.3c-0.4,0.3-1.2,1-1.6,1.3l-0.4,0.3c-1,0.6-2.1,1.3-2.6,1.7
						...
						L53.6,5c-0.3-0.4-1.4-1.2-1.9-1.6c-0.4-0.4-1-1-1.4-1.3l-0.4-0.3C49.3,1.3,48.6,0.9,48.4,0.9"/>
					<path fill="#454545" d="M110,15.5c-0.3-0.6-1.4-0.4-2.5,0.3l-0.3,0.2c-0.3,0.2-2.5,1-2.8,1.3c-0.3,0.3-1.3,1.2-2,1.6
						...
						c0.2-0.7,0.9-3.7,0.9-4.4c0-0.8,0.8-3,0.8-3.8c0-0.8,0.9-8.6,0.9-9.2s0.5-12,0.5-13v-3.2V16V15.5z"/>
					<path fill="#454545" d="M123.2,15.2c-0.3,0-0.9,0.2-1.4,1c-0.5,0.8-0.8,1.2-1.2,1.6l-0.4,0.4c-0.5,0.6-1.3,1.6-1.7,2.3v0.3
						...
						l-1-0.7L123.2,15.2z"/>
					<path fill="#454545" d="M142.7,14.7c-0.2,0-2,0.7-2.4,1.1c-0.4,0.4-1,0.7-1.4,1c-0.4,0.3-1,0.9-1.4,1c-0.3,0.2-0.8,0.6-1.4,0.9
						...
						C143.6,14.8,142.7,14.7,142.7,14.7"/>
					<path fill="#454545" d="M152,18.7c-0.3,0.1-1.2,2.1-1.1,2.2c0.1,0,1.1,0.8,1.1,0.9c0,0.1,0.9,1,1.1,1c0.2,0,2.1,0.3,2.7,0.3
						...
						c-0.9,0.4-5.1,2.5-5.6,2.8c-0.5,0.3-2,1-3.2,1.9C154,16.8,153,18.3,152,18.7"/>
					</svg>
				</div>
				<div class="col-s-9 col-xs-16 left">
					<p>
						&copy; 2005-<?php echo date("Y"); ?> Michael Azgour, Artist. All rights reserved.
					</p>
				</div>
