...
<div class="container-full contact">
	...
	<?php if (have_rows('links')) : ?>
		<div class="row follow">
			<div class="col-l-53">
				<h1 style="text-transform:none;"><?php echo get_field('title'); ?></h1>
				...
				<div class="row the-follow">
					...
					?>
						<div class="col-s-32 col-xs-16">
							...
							?>
							<a href="<?php echo $link; ?>" <?php echo $target ? 'target="_blank"' : null; ?>><img src="<?php echo $url; ?>" alt="<?php echo $alt; ?>"></a>
						</div>
					<?php endwhile; ?>
