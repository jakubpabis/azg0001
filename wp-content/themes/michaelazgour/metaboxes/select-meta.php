<div class="my_meta_control">
 <?php /*
	 ...
	 */?>
	<br/>
	<label class="project-left-column">Title (left column)</label>
	<label class="project-right-column">Description (right column)</label>

	<?php while($mb->have_fields_and_multi('s_group')): ?>
	<?php $mb->the_group_open(); ?>

		<?php $mb->the_field('title'); ?>
		<input class="project-left-column" type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>

		<?php $mb->the_field('description'); ?>
		<textarea class="project-right-column" name="<?php $mb->the_name(); ?>"><?php $mb->the_value(); ?></textarea>
	...
	<p><a href="#" class="docopy-s_group button"><?php echo __('Add field', 'rijnboutt'); ?></a></p>
