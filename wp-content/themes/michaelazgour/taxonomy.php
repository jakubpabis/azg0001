...
<div class="container-full paintings">
	...
	<?php if (have_posts()) : ?>
		...
		?>
			...
			$data = isset($meta1['title']) ? $meta1['title'] : null;
			$description = isset($meta1['description']) ? $meta1['description'] : null;
			$sold = isset($meta1['is_sold']) ? $meta1['is_sold'] : null;
			$not_show = isset($meta1['not_main']) ? $meta1['not_main'] : null;
			?>
			<?php if (!$not_show) : ?>
				<?php
