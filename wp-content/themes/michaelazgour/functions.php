...
function azgour_scripts() {
	wp_enqueue_script( 'azgour-jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js', array( 'jquery' ), NULL, true );
	...
	wp_enqueue_script( 'azgour-functions', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '1.97', true );
...
function create_news_exhibitions() {
	...
	register_post_type( 'news_exhibitions',
	// CPT Options
		array(
			'labels' => array(
				...
				<?php
					if($module1 !== "none"){
						...
						?>
							...
							<a href="<?php echo $metaL1; ?>"<?php if($metaNT1){echo'target="_blank"';} ?>></a>
						<?php
					}
				?>
			</div>
				...
				<?php
					if($module2 !== "none"){
						...
						?>
							...
							<a href="<?php echo $metaL2; ?>"<?php if($metaNT2){echo'target="_blank"';} ?>></a>
						<?php
					}
				?>
			</div>
				...
				<?php
					if($module3 !== "none"){
						...
						?>
							...
							<a href="<?php echo $metaL3; ?>"<?php if($metaNT3){echo'target="_blank"';} ?>></a>
						<?php
					}
				?>
			</div>
